...
class Test_ohrm_login():
    ...
    def test_click_login(self):
        self.wait.until(expected_conditions.visibility_of_element_located(self.login_tf))
        self.driver.find_element(*Test_ohrm_login.login_tf).click()
